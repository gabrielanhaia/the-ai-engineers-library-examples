# Inference Engineering in Practice — labs

The labs for *Inference Engineering in Practice* (The AI Engineer's Library, Volume 3).
...
```sh
docker compose run --rm inference-engineering-in-practice list        # labs present
docker compose run --rm inference-engineering-in-practice models list # model sets
docker compose run --rm inference-engineering-in-practice test ch00   # what CI runs
docker compose run --rm inference-engineering-in-practice clean       # leftovers
```
...
|---|---|---|
| `cpu` (default) | every lab, on the CPU | `docker compose run --rm inference-engineering-in-practice chNN` |
